                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                              ...
                              <tbody>
                                <tr v-for="item in itemList" :key="item.id">
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.id }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.name }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.price }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">
                                    <select name="quantity" v-model="item.quantity">
                                      <option v-for="q in quantity" :value="q">{{ q }}</option>
                                    </select>
                                  </td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.price * item.quantity }}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
