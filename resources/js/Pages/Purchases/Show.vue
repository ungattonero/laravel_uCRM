                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                              ...
                              <tbody>
                                <tr v-for="item in props.items" :key="item.id">
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.item_id }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.item_name }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.item_price }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.quantity }}</td>
                                  <td class="border-t-2 border-gray-200px-4 py-3">{{ item.subtotal }}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
