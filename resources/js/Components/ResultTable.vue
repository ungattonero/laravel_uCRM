...
<template>
  <div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 w-full mx-auto overflow-auto">
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        <tbody>
          <tr v-for="item in data.data.data" :key="item.date">
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.date }}</td>
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.total }}</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto">
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        <tbody>
          <tr v-for="item in data.data.data" :key="item.date">
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.decile }}</td>
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.average }}</td>
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.totalPerGroup }}</td>
            <td class="border-t-2 border-gray-200px-4 py-3">{{ item.totalRatio }}</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
      ...
      <tbody>
        <tr v-for="rfm in data.eachCount" :key="rfm.rank">
          <td class="border-t-2 border-gray-200px-4 py-3">rfm.rank</td>
          <td class="border-t-2 border-gray-200px-4 py-3">rfm.r</td>
          <td class="border-t-2 border-gray-200px-4 py-3">rfm.f</td>
          <td class="border-t-2 border-gray-200px-4 py-3">rfm.m</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table-auto w-full text-left whitespace-no-wrap">
      ...
      <tbody>
        <tr v-for="rf in data.data" :key="rf.rRank">
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.rRank }}</td>
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.f_5 }}</td>
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.f_4 }}</td>
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.f_3 }}</td>
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.f_2 }}</td>
          <td class="border-t-2 border-gray-200px-4 py-3">{{ rf.f_1 }}</td>
        </tr>
      </tbody>
    </table>
    </div>
